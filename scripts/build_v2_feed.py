...
def flags(p):
    ...
    return {
      ...
      "_alg_olive": bool(__import__("re").search(r"OLEA EUROPAEA|\bOLIVE\b", b)),
      "_alg_castor": any(t in b for t in ["RICINUS","CASTOR"]),
      "_alg_avocado": any(t in b for t in ["PERSEA","AVOCADO"]),
      "_alg_citrus": any(t in b for t in ["CITRUS","BERGAMOT","ORANGE OIL","LEMON","LIME","GRAPEFRUIT","MANDARIN","TANGERINE"]),
      ...
      "_alg_soy": (any(t in b for t in ["GLYCINE SOJA","SOYBEAN","SOJA","HYDROLYZED SOY","SOY PROTEIN","SOY ISOFLAVON","LECITHIN, SOY","SOY LECITHIN"]) or ("LECITHIN" in b and "SUNFLOWER" not in b and "SOJA" not in b)),
