...
PATTERNS = {
    ...
    'contamination': r'contaminat|foreign (?:material|object|matter)|metal (?:fragment|piece)|plastic fragment|glass (?:fragment|piece)|wood fragment',
    ...
    'mold':          r'\bmold\b|\bmould\b|fungal',
...
SPECIFICITY = ['botulism', 'bacteria', 'contamination', 'lead', 'magnet', 'battery',
               ...
               'entanglement', 'overheat', 'chemical', 'subpotent', 'undeclared',
