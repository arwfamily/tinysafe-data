...
if __name__ == '__main__':
    ...
    # Full record set with all 73 fields. Opt-in: it is 17 MB, regenerable from
    # the same inputs, and large enough to fail GitHub's web uploader — so it is
    # not written unless asked for.
    if os.environ.get('WRITE_FULL') == '1':
