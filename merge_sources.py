...
def enrich(rec):
    ...
    # Computed, not defaulted. The rule from the architecture doc: everything is
    # searchable, the feed shows 2016 onward. Leaving it at a bare True made
    # 1996, 2008 and 2009 warnings claim to be in the current feed.
