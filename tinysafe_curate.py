...
# Widened after 23 survived the first pass. A trademark sign can be followed by
# a digit ("UDI/DI\u00bf1502131200069"), by another lost byte ("Bravo\u00bf\u00bf"), or by nothing.
# What must NOT be touched is a \u00bf sitting BETWEEN two letters - that is a lost
# accent, not a symbol: "Dr\u00bfger" is Dr\u00e4ger and deleting it gives "Drger". The
# standalone case ("\u00bf fl oz") is the fraction, left as before.
_TM_LOST = re.compile(r'(?<=[A-Za-z0-9])\u00bf+(?![A-Za-z])')
