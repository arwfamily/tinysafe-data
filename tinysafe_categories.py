...
GROUPS = {
    ...
    'Feeding': ['Feeding & high chairs', 'Food & formula', 'Oral care & teething'],
    ...
    'Health': ['Medications & supplements', 'Personal care & medicine',
               'Skincare, bath & diapering', 'Medical devices'],
}
GROUP_OF = {f: g for g, fams in GROUPS.items() for f in fams}


def group(family_name):
    """Browse group for a family. Unclassified records group as 'Other'."""
