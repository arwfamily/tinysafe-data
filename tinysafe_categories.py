...
FAM = [
 ...
 ('Feeding & high chairs',              r'high ?chair|booster.{0,12}chair|hook.?on chair|feeding pillow|self.?feeding|sippy|pacifier|soother|teether|bib|breast pump|baby bottle|nursing bottle|feeding bottle|bottle warmer|bottle brush|bottle steriliz|highchair|spoon|fork|cups?\b|plates?\b|bowls?\b|tableware|dish|utensil|placemat|snack|\bcand(?:y|ies)\b|straw|tumbler|thermos|lunch ?box|water bottle|drinking'),
 ...
 ('Medical devices',                   r'ventilat\w*|respirator\w*|resuscitat|forceps|blood pressure|cuff\b|catheter|intubation|neonatal|nicu|'
                                       ...
                                       r'drainage|tracheal|manometer|stethoscope|infusion|feeding tube|apnea|'
...
DEFINITIVE = [
    ('Toys', re.compile(r'\btoys?\b', re.I)),
    ...
    ('Sleep — cribs, bassinets, loungers', re.compile(r'\bcribs?\b|\bbassinets?\b', re.I)),
